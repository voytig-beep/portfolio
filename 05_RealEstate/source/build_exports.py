...
PPTX = ROOT / "Liora_real_estate_deck.pptx"
PDF = ROOT / "Liora_real_estate_deck.pdf"
GIF = EXPORTS / "Liora_video_preview.gif"
...
def build_contact_sheet(images: list[Path]) -> None:
    ...
    sheet = Image.new("RGB", (thumb_w * 2, thumb_h * 5), (14, 18, 18))
...
<head>
  ...
  <style>
    ...
    html, body {{ margin: 0; padding: 0; background: #0b0f10; }}
