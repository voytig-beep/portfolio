...
PPTX = ROOT / "Asteria_annual_report_2025.pptx"
PDF = ROOT / "Asteria_annual_report_2025.pdf"
GIF = EXPORTS / "Asteria_video_preview.gif"
...
def build_contact_sheet(images: list[Path]) -> None:
    ...
    sheet = Image.new("RGB", (thumb_w * 2, thumb_h * 5), (223, 228, 223))
...
<head>
  ...
  <style>
    ...
    html, body {{ margin: 0; padding: 0; background: #dfe4df; }}
