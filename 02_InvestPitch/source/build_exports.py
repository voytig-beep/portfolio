...
PPTX = ROOT / "FlowPilot_investment_pitch.pptx"
PDF = ROOT / "FlowPilot_investment_pitch.pdf"
GIF = EXPORTS / "FlowPilot_video_preview.gif"
...
def build_contact_sheet(images: list[Path]) -> None:
    ...
    cols = 2
    rows = 5
    sheet = Image.new("RGB", (thumb_w * cols, thumb_h * rows), (8, 9, 8))
